...
const getNodeKey = async (verifier: string, verifierId: string, idToken: string) => {
...
export const getShareBSuccess = async (verifier: string, verifierId: string, idToken: string): Promise<KeyPair> => {
  return await {
    ethAddress: "0x04e407c7d7c2a6aa7f2e66b0b8c0dbcafa5e3afe",
    priKey: "e19d5570950218a0f385f098b9b6c050a63aca31a286da271075a33a8ae7b3da",
  };
};
